...
<div class="wrapper">
    <div class="landing-header" style="background-image: url('http://localhost:8888/static/assets/site/images/landing.jpg'); box-shadow:inset 0 0 0 2000px rgba(255,255,255,0.7);">
    <div class="container">
        <div class="motto">
        ...
        <div class="container">
            ...
            <div class="col-md-4">
                <div class="team-player">
                    <img src="http://localhost:8888/static/assets/site/images/placeholder.jpg" alt="Thumbnail Image" class="img-circle img-responsive">
            ...
            <div class="col-md-4">
                <div class="team-player">
                    <img src="http://localhost:8888/static/assets/site/images/placeholder.jpg" class="img-circle img-responsive">
            ...
            <div class="col-md-4">
                <div class="team-player">
                    <img src="http://localhost:8888/static/assets/site/images/placeholder.jpg" class="img-circle img-circle img-responsive">
